...
public class WifiChatBroadcastReceiver extends BroadcastReceiver {
    private WifiP2pManager mWifiP2pManager;
    private WifiP2pManager.Channel mChannel;
    private ChatActivity mActivity;

    public WifiChatBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, ChatActivity activity) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (networkInfo.isConnected()) {
                mActivity.imageButton_send.setTag("online");
                ...
                mActivity.textView_status.setText("(Device_Disconnected)");
                Toast.makeText(context, "user is offline", Toast.LENGTH_SHORT).show();
                mActivity.imageButton_send.setTag("offline");
            }
